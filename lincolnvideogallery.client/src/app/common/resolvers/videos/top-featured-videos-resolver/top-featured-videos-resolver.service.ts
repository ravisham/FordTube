...
export class TopFeaturtedVideosResolverService implements Resolve<VideoSearchResponseModel> {
  constructor(private videoService: VideoService) {}

  resolve(): Observable<VideoSearchResponseModel> {
    return this.videoService.topFeatured(false).pipe(response => response);
  }
}
