...
export class ManageCarouselComponent implements OnInit { 
  ...
  public addSlideToUI(ngbTabSet: NgbTabset) {
    ...
    newSlide.isNew = true;
    newSlide.activeDate = undefined;
    newSlide.activeTime = undefined;
    newSlide.inactiveDate = undefined;
    newSlide.inactiveTime = undefined;
    newSlide.backgroundColor = undefined;
    newSlide.franchise = environment.franchise;
    newSlide.link = undefined;
    newSlide.text = undefined;
  ...
  public changeSlideImage(slide: SlideMap) {
    ...
    if (slideToUpdate) {
      slideToUpdate.backgroundImageUrl = undefined;
  ...
  public saveSlide(slide: SlideMap) {   
    ...
    const dtoSlide = slide.toDto() || undefined;

    const activeDate = dtoSlide.activeDate;
    if (activeDate !== null) {
      slide.activeDate = moment(activeDate, "YYYY-MM-DD").toDate();
    }

    const inactiveDate = dtoSlide.inactiveDate;
  ...
  public onFileChange(event: any, slide: SlideMap) {
    ...
    fileReader.onload = (progressEvent: ProgressEvent) => {
      slide.backgroundImage = (fileReader.result as string).toString()
        .split(',')
        .pop();
    };
  ...
  private slideToDto(slideId: number): SlideDtoModel {
    ...
    const returnDto = slideToUpdate.toDto() || undefined;
    

    return returnDto as SlideDtoModel;
  }
}
