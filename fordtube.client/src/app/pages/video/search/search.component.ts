...
export class SearchComponent implements OnInit {
  ...
  filter: SearchInterface = {
    categoryIds: this.currentRoute.snapshot.queryParamMap.get('c') ? [this.currentRoute.snapshot.queryParamMap.get('c') as string] : ['all'],
  ...
  callSearch() {
    ...
    window["dataLayer"].push({
      ...
      pageTitle: categoryFullPath ? categoryFullPath['fullpath'] : ''
    });
  }
